<?php
	...
	#TD3
	$voiture = Voiture::getVoitureByImmat("AX679DB");
	echo "<p>" . $voiture->afficher() . "</p>";


	$fiat = new Voiture("Fiat","Jaune","ANDY-38");
	Voiture::save($fiat);

	$testRecupFiat = Voiture::getVoitureByImmat("ANDY-38");

	echo "<p>" . $testRecupFiat ->afficher() . "</p>";
?>